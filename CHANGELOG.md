...
- PHP 8.4 deprecation: added explicit `$escape` parameter to `fgetcsv()` calls in CsvImporter

### Added

- WordPress Playground blueprint for live preview on wordpress.org
- WordPress 7.0 to CI integration test matrix
