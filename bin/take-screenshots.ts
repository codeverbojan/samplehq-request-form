...
async function main() {
	...
	await page.goto(
		`${ BASE }/wp-admin/admin.php?page=shqf-forms&action=edit&id=20`
	);
	await page.waitForLoadState( 'networkidle' );
	...
	await page.goto(
		`${ BASE }/wp-admin/admin.php?page=shqf-submissions&form_id=20`
	);
	await page.waitForLoadState( 'networkidle' );
	await hideWpNoise( page );
	await page.screenshot( {
	...
	const picker = frontPage
		.locator( '.shqf-picker-grid, .shqf-picker-items, .shqf-fields' )
		.first();
	...
	await page.goto(
		`${ BASE }/wp-admin/admin.php?page=shqf-settings&tab=spam`
	);
	await page.waitForLoadState( 'networkidle' );
	await hideWpNoise( page );
	await page.screenshot( {
	...
	await page.goto(
		`${ BASE }/wp-admin/admin.php?page=shqf-samples&action=edit&id=5`
	);
	await page.waitForLoadState( 'networkidle' );
	...
	const grid = frontPage
		.locator( '.shqf-picker-grid, .shqf-picker-items' )
		.first();
